...
chords = {
    "left": {
        ...
        "index": [57, 60, 64],   # A Minor (A, C, E)
        "middle": [59, 62, 65],  # B Diminished (B, D, F)
        "ring": [60, 64, 67],    # C Major (C, E, G)
        "pinky": [62, 65, 69]    # D Minor (D, F, A)
    },
    "right": {
        "thumb": [55, 59, 62],   # G Major
        "index": [57, 60, 64],   # A Minor
        "middle": [59, 62, 65],  # B Diminished
        "ring": [60, 64, 67],    # C Major
        "pinky": [62, 65, 69]    # D Minor
    }
}
